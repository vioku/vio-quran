      ...
      {isloading ? (
        ...
        <>
          <div className='flex justify-between gap-x-2 items-center mb-5 '>
            <h2 className='text-lg font-semibold'>{infodata.title}</h2>
            <div>
          ...
          <p className='text-right text-3xl mb-4 ibm leading-relaxed'>{infodata.arabic}</p>
          <p className='mb-3'>
            <span className='text-primary'>"{infodata.latin}"</span> {infodata.source && <>({infodata.source})</>}
          </p>
          <p className='mb-3'>Arti: "{infodata.translation}"</p>
          {infodata.notes && (
            <div className='bg-secondary p-2 rounded-md mb-3'>
              <p className=''>{infodata.notes}</p>
            </div>
          )}
          {infodata.fawaid && (
            <div className='bg-secondary p-2 rounded-md italic'>
